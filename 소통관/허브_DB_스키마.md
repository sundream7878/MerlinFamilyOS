# 🏛️ 허브 DB 스키마 (Hub Database Schema)
> [!CAUTION]
> **절대 손대지 말 것. 멀린(공장장) 전용 작업 대상.**
> AI(안티, 윈드)는 이 파일을 임의로 수정하거나 갱신할 수 없습니다.

- **최종 업데이트**: 2026-04-27 00:42:06 (KST)
- **관리 원칙**: 이 문서는 허브 DB의 실제 상태를 반영하며, 모든 앱 연동의 기준이 된다.
